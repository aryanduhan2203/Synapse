...
export default async function DasCaseStudyPage({
  params,
}: {
      ...
      <main className="flex-grow bg-[#0c0d14] text-slate-100 overflow-hidden font-sans">
        ...
        <section className="relative pt-24 pb-16 md:pt-32 md:pb-24">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <p className="text-lg sm:text-xl font-medium text-slate-300 mb-12 tracking-wide select-none max-w-3xl mx-auto">
              {cs.subtitle.split(/(DAS)/).map((part: string, idx: number) => 
                part === "DAS" ? (
                  <span key={idx} className="text-[#e2c073] font-bold">{part}</span>
                ) : (
                  part
                )
              )}
            ...
            {/* Hero Banner Image */}
            <div className="relative w-full max-w-6xl mx-auto rounded-3xl overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.5)] aspect-video md:aspect-[2.5/1]">
              <Image
                src="/images/das/hero_screen.png"
                alt="DAS E-Commerce Preview"
                fill
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
              ...
              <div className="lg:col-span-6 flex justify-center items-center relative">
                {/* Glow backdrop */}
                <div className="absolute w-[300px] h-[300px] bg-[#e2c073]/10 rounded-full blur-[80px] pointer-events-none"></div>
                
                <div className="relative w-full max-w-[480px] aspect-[4/3] rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
                  <Image
                    src="/images/das/overview.png"
                    alt="DAS Luxury Overview"
                    fill
                    className="object-cover hover:scale-105 transition-transform duration-700"
                  />
                  
                  {/* Premium floating ribbon badge */}
                  <div className="absolute top-4 right-4 bg-gradient-to-r from-stone-800 to-black text-[#e2c073] text-xs font-black tracking-wider uppercase px-4 py-2 rounded-xl shadow-lg border border-[#e2c073]/30 flex items-center gap-1.5">
                    <span>★</span>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
                ...
                <div className="lg:col-span-6 flex justify-center items-center relative">
                  <div className="relative w-full max-w-[480px] aspect-[4/3] rounded-3xl overflow-hidden border border-slate-100 shadow-xl">
                    <Image
                      src="/images/das/challenge.png"
                      alt="DAS Platform Challenge"
                      fill
                      className="object-cover hover:scale-105 transition-transform duration-700"
                    />
                    {/* Code overlay */}
                    <div className="absolute bottom-4 left-4 bg-slate-950/85 border border-[#e2c073]/30 rounded-xl p-3 font-mono text-[9px] sm:text-[10px] text-[#e2c073] shadow-xl max-w-[240px] leading-relaxed hidden sm:block">
                      <span className="text-slate-500">// Optimized asset pipeline</span><br />
                      <span className="text-purple-400">const</span> <span className="text-blue-400">visual</span> = <span className="text-purple-400">await</span> engine.render(couture);<br />
                      <span className="text-purple-400">return</span> visual.hd;
                    </div>
                  </div>
                </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
              ...
              <div className="lg:col-span-6 flex justify-center items-center relative">
                <div className="relative w-full max-w-[480px] aspect-[4/3] rounded-3xl overflow-hidden border border-slate-100 shadow-xl">
                  <Image
                    src="/images/das/solution.png"
                    alt="DAS Platform Solution"
                    fill
                    className="object-cover hover:scale-105 transition-transform duration-700"
                  />
                </div>
        ...
        <section className="w-full bg-[#161a23] py-16 relative overflow-hidden border-t border-slate-800/50">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 relative z-10 flex flex-col items-center text-center">
            {/* DAS Logo */}
            <div className="mb-8 select-none bg-white py-4 px-10 rounded-lg inline-block shadow-lg">
              <div className="flex justify-center items-center gap-1 mb-1">
                <span className="text-[44px] font-black text-[#1a1a1a] tracking-wider leading-none font-sans">D</span>
                <svg width="44" height="44" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[#1a1a1a] mt-1 mx-1">
                  <path d="M12 4L5 19H9L12 11L15 19H19L12 4Z" fill="currentColor"/>
                </svg>
                <span className="text-[44px] font-black text-[#1a1a1a] tracking-wider leading-none font-sans">S</span>
              </div>
              <div className="text-[11px] font-bold tracking-widest text-[#1a1a1a] text-center font-sans uppercase mt-1">
                Timeless Luxury Abayas
              </div>
            </div>
