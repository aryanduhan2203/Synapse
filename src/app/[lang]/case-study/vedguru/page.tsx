...
export default async function VedguruCaseStudyPage({
  params,
}: {
  ...
  const cs = dict.caseStudyVedguru;
      ...
      <main className="flex-grow bg-[#0c0d14] text-slate-100 overflow-hidden font-sans">
        ...
        <section className="relative pt-24 pb-16 md:pt-32 md:pb-24">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            {/* Subtitle */}
            <p className="text-lg sm:text-xl font-medium text-slate-300 mb-12 tracking-wide select-none max-w-4xl mx-auto">
              How We Helped <span className="text-[#02a971] font-bold">Vedguru</span> Transform Online Astrology Consultations and Increase User Engagement by 45%
            </p>

            {/* Hero Banner Image */}
            <div className="relative w-full max-w-6xl mx-auto rounded-3xl overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.5)]">
              <Image
                src="/images/vedguru/hero.png"
                alt="Vedguru Hero Banner"
                width={1200}
                height={480}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
              ...
              <div className="lg:col-span-6 flex justify-center items-center relative">
                ...
                <div className="relative w-full max-w-[480px] aspect-[4/3] rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
                  <Image
                    src="/images/vedguru/overview.png"
                    alt="Vedguru Mystical Astrology Overview"
                    fill
                    className="object-cover hover:scale-105 transition-transform duration-700"
                  />
                  
                  {/* Premium floating ribbon badge */}
                  <div className="absolute top-4 right-4 bg-gradient-to-r from-purple-600 to-fuchsia-600 text-white text-xs font-black tracking-wider uppercase px-4 py-2 rounded-xl shadow-lg border border-white/10 flex items-center gap-1.5">
                    <span>✧</span>
                    <span>Top Astrologers</span>
                  </div>
                </div>
              </div>
        ...
        <section className="w-full bg-[#161a23] py-16 relative overflow-hidden border-t border-slate-800/50">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 relative z-10 flex flex-col items-center text-center">
            ...
            <div className="mb-6 select-none flex justify-center">
              <svg width="64" height="64" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="mx-auto">
                <circle cx="50" cy="50" r="46" stroke="#f97316" strokeWidth="2" strokeDasharray="4 4"/>
                <circle cx="50" cy="50" r="32" stroke="#f97316" strokeWidth="1"/>
                <circle cx="50" cy="50" r="28" stroke="#f97316" strokeWidth="1"/>
                <g stroke="#f97316" strokeWidth="1.5">
                  <path d="M50 4 v10 M50 86 v10 M4 50 h10 M86 50 h10 M17.5 17.5 l7 7 M75.5 75.5 l7 7 M17.5 82.5 l7 -7 M75.5 24.5 l7 -7" />
                </g>
                <text x="50" y="58" fontFamily="sans-serif" fontSize="26" fill="#f97316" textAnchor="middle" fontWeight="bold">VG</text>
              </svg>
            </div>
            ...
            <div className="relative w-full max-w-4xl px-8 sm:px-12">
              <span className="absolute top-0 -left-2 sm:-left-2 text-4xl text-[#2ebf9b] font-serif leading-none select-none font-bold italic">{"//"}</span>
              <p className="text-white/95 text-base sm:text-[1rem] leading-[2] font-normal tracking-wide">
                {cs.testimonial.quote}
              </p>
              <span className="absolute -bottom-4 -right-2 sm:-right-2 text-4xl text-[#2ebf9b] font-serif leading-none select-none font-bold italic">{"//"}</span>
            </div>
