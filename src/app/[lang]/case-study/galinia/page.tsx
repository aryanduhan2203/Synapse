...
export default async function GaliniaCaseStudyPage({
  params,
}: {
  ...
  const cs = dict.caseStudyGalinia;
      ...
      <main className="flex-grow bg-[#0c0d14] text-slate-100 overflow-hidden font-sans">
        ...
        <section className="relative pt-24 pb-16 md:pt-32 md:pb-24">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <div className="relative w-full max-w-6xl mx-auto rounded-3xl overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.5)] aspect-video md:aspect-[2.5/1]">
              <Image
                src="/images/galinia/hero.png"
                alt="MentalWell Hero Banner"
                fill
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
              ...
              <div className="lg:col-span-6 flex justify-center items-center relative">
                {/* Glow backdrop */}
                <div className="absolute w-[300px] h-[300px] bg-emerald-500/10 rounded-full blur-[80px] pointer-events-none"></div>
                
                <div className="relative w-full max-w-[480px] aspect-[4/3] rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
                  <Image
                    src="/images/galinia/overview.png"
                    alt="MentalWell App Overview"
                    fill
                    className="object-cover hover:scale-105 transition-transform duration-700"
                  />
                  
                  {/* Premium floating ribbon badge */}
                  <div className="absolute top-4 right-4 bg-gradient-to-r from-emerald-500 to-teal-500 text-white text-xs font-black tracking-wider uppercase px-4 py-2 rounded-xl shadow-lg border border-white/10 flex items-center gap-1.5">
                    <span>♥</span>
                    <span>Top Wellness App</span>
                  </div>
                </div>
              </div>
        ...
        <section className="w-full bg-[#161a23] py-16 relative overflow-hidden border-t border-slate-800/50">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 relative z-10 flex flex-col items-center text-center">
            {/* Logo placeholder */}
            <div className="mb-6 select-none relative w-20 h-20 rounded-full overflow-hidden border-2 border-emerald-500/30">
              <Image src="/images/galinia/badge.png" alt="MentalWell Logo" fill className="object-cover" />
            </div>
